...
def scrape_all_new_games():
    url = "https://slotra.com/casino/new"
    ...
    with sync_playwright() as p:
        ...
        try:
                        ...
                        if href not in games_dict:
                            ...
                            if img_src:
                                ...
                                if not filename.endswith(".avif"):
                                    filename += ".avif"
                                local_img_path = f"/assets/slots/new/{filename}"
                            
                            games_dict[href] = {
                                "id": f"new_full_{len(games_dict)}",
                                "title": title,
                                "provider": "Various",
            ...
            final_games_list = games_data

            print(f"Toplam {len(final_games_list)} adet oyun bilgisi başarıyla çekildi!")
            
            output_path = os.path.join("public", "slots_all_new.json")
