...
def scrape_megaways_list():
    url = "https://slotra.com/casino/megaways"
    print(f"{url} adresindeki Megaways oyunlarının LİSTESİ kazınıyor...")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            output_path = os.path.join("public", "megaways_raw.json")
            with open(output_path, "w", encoding="utf-8") as f:
                json.dump(games_data, f, ensure_ascii=False, indent=2)
                
            print(f"Megaways oyunları listesi '{output_path}' dosyasına kaydedildi.")
