export default async function handler(req, res) {
  ...
  try {
    // In production, you would fetch from the real external API provider:
    // const response = await fetch('https://dummy-sports-api.com/raw');
    ...
    console.error('Error fetching sports data in serverless function:', error);
