...
def scrape_missing_bonusbuy_iframes():
    json_path = os.path.join("public", "bonusbuy_missing.json")
    ...
    print(f"Toplam {len(games)} eksik bonusbuy oyununun iframe linkleri aranacak. İşlem başlıyor...")
    ...
    with sync_playwright() as p:
        ...
        try:
            page.goto("https://slotra.com", wait_until="commit", timeout=30000)
            time.sleep(3) 
        except Exception as e:
            print(f"Ana sayfa ön yüklemesinde zaman aşımı veya hata (Önemsiz): {e}")
        ...
        output_path = os.path.join("public", "bonusbuy_missing_with_iframes.json")
...
if __name__ == "__main__":
    scrape_missing_bonusbuy_iframes()
