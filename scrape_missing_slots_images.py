...
SAVE_DIR = "public/assets/slots/all_slots"
...
def scrape_missing_slots_images():
    ...
    print(f"Toplam {len(games)} eksik slot oyununun resimleri indirilecek...")
    ...
    with sync_playwright() as p:
        ...
        for i, game in enumerate(games):
            ...
            game["image"] = f"/assets/slots/all_slots/{filename}"
