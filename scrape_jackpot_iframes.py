...
def scrape_jackpot_iframes():
    ...
    print(f"Toplam {len(games)} Jackpot oyununun iframe linkleri aranacak...")
    ...
    with sync_playwright() as p:
        ...
        output_path = os.path.join("public", "jackpot_with_iframes.json")
