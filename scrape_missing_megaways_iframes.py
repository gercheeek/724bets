...
def scrape_missing_megaways_iframes():
    ...
    print(f"Toplam {len(games)} eksik megaways oyununun iframe linkleri aranacak. İşlem başlıyor...")
    ...
    with sync_playwright() as p:
        ...
        output_path = os.path.join("public", "megaways_missing_with_iframes.json")
...
if __name__ == "__main__":
    scrape_missing_megaways_iframes()
