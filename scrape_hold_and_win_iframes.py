...
def scrape_hold_and_win_iframes():
    json_path = os.path.join("public", "slots_hold_and_win.json")
    ...
    with sync_playwright() as p:
        ...
        output_path = os.path.join("public", "slots_hold_and_win_with_iframes.json")
