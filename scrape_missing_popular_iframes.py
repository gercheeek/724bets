...
def scrape_missing_popular_iframes():
    ...
    print(f"Toplam {len(games)} eksik oyunun iframe linkleri aranacak. İşlem başlıyor...")
    ...
    with sync_playwright() as p:
        ...
        output_path = os.path.join("public", "slots_popular_missing_with_iframes.json")
...
if __name__ == "__main__":
    scrape_missing_popular_iframes()
