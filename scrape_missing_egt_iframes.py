...
def scrape_missing_egt_iframes():
    json_path = os.path.join("public", "egt_search_raw.json")
    ...
    print(f"Toplam {len(games)} EGT oyununun iframe linkleri aranacak...")
    ...
    with sync_playwright() as p:
        ...
        for i, game in enumerate(games):
            original_link = game.get("original_link")
        ...
        output_path = os.path.join("public", "egt_search_with_iframes.json")
