...
def scrape_slots_list():
    url = "https://slotra.com/casino/slots"
    print(f"{url} adresindeki slot oyunlarının LİSTESİ kazınıyor...")
    ...
    with sync_playwright() as p:
        ...
        try:
            ...
            time.sleep(5)
            print("Sayfa yüklendi, sayfa sonuna kadar kaydırılıyor... (Bu biraz sürebilir, çok fazla oyun olabilir)")
            ...
            while True:
                ...
                if len(games_dict) >= 100:
                    print(f"İstenilen sayıya ({len(games_dict)}) ulaşıldı, kaydırma durduruluyor.")
                    break
            ...
            output_path = os.path.join("public", "slots_raw.json")
            with open(output_path, "w", encoding="utf-8") as f:
                json.dump(games_data, f, ensure_ascii=False, indent=2)
                
            print(f"Slot oyunları listesi '{output_path}' dosyasına kaydedildi.")
