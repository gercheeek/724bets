        ...
        <section id="daily-coupons" className="relative w-full bg-zinc-900/40 backdrop-blur-md rounded-lg p-4 md:p-6 h-full flex flex-col">
            ...
            <div className="flex overflow-x-auto gap-1.5 mb-3 pb-1 justify-start scrollbar-none animate-fade-in-up">
                <button
                    ...
                    className={`flex flex-col items-center justify-center min-w-[55px] h-[38px] rounded-lg transition-all duration-300 ${selectedDate === 'WEEKLY'
                        ? 'bg-[#06b6d4] text-black shadow-[0_2px_10px_rgba(0,255,163,0.2)]'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-[8px] font-black uppercase tracking-widest transition-all duration-300 shrink-0 ${
                            selectedCategory === cat
                                ? 'bg-[#06b6d4] text-black shadow-[0_0_10px_rgba(0,255,163,0.15)]'
            ...
            <div className="flex flex-col gap-4 flex-1">
                                ...
                                <div key={coupon.id} className="relative group" style={{ animationDelay: `${index * 0.1}s` }}>
                                    ...
                                    <div className="rounded-lg p-5 pointer-events-none bg-[#0A0C10]" style={{ filter: 'blur(4px)', userSelect: 'none', boxShadow: 'var(--shadow-card)' }}>
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex gap-1.5 flex-wrap">
                                                <div className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5 ${isLow ? 'bg-[#00E5FF]/10 text-[#00E5FF]' : isHigh ? 'bg-rose-500/10 text-rose-500' : 'bg-[#06b6d4]/10 text-[#06b6d4]'}`}>
                                        ...
                                        <div className="space-y-2 mb-3">
                                            {coupon.matches.slice(0, 3).map((m, i) => (
                                                <div key={i} className="flex items-center justify-between rounded-lg p-3 bg-[#22262F]">
                                                    ...
                                                    <span className="text-[#06b6d4] text-xs font-black ml-2">{m.odd}</span>
                                                </div>
                                            ))}
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span style={{ color: 'var(--text-dim)', fontSize: '10px', fontWeight: 'bold' }}>TOPLAM ORAN</span>
                                            <span className="text-[#06b6d4] text-sm font-black">{coupon.totalOdd}</span>
                                        </div>
                                    </div>
                                    {/* Lock Overlay */}
                                    <div className="absolute inset-0 rounded-lg flex flex-col items-center justify-center backdrop-blur-[2px]" style={{ background: 'color-mix(in srgb, var(--bg-card) 60%, transparent)' }}>
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-5 py-2.5 bg-[#06b6d4] text-black font-black text-xs rounded-full uppercase tracking-widest hover:bg-[#06b6d4]/90 transition-all shadow-[0_0_20px_rgba(0,255,163,0.3)] hover:shadow-[0_0_30px_rgba(0,255,163,0.5)]"
                                        >
                            ...
                            >
                                        ...
                                        <div key={midx} className="relative">
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-[#06b6d4] font-black text-xs">{match.odd}</span>
                                                </div>
                                                <div className="flex items-center gap-1.5">
                                                    <div className="h-px w-4 bg-[#06b6d4]/30 rounded-full" />
                                ...
                                <div className="mb-3 space-y-1.5">
                                    <div className="flex justify-between items-center text-[8px] font-black text-[#9CA3AF] uppercase tracking-widest">
                                        ...
                                        <span className={isLow ? 'text-[#00E5FF]' : isHigh ? 'text-rose-500' : 'text-[#06b6d4]'}>
                                            {coupon.riskLevel}
                                        </span>
                                    </div>
                                    <div className="h-1 w-full bg-black/5 rounded-full overflow-hidden">
                                        <div className={`h-full rounded-full transition-all duration-1000 ${isLow ? 'w-[30%] bg-[#00E5FF] shadow-[0_0_10px_rgba(16,185,129,0.5)]' :
                                            isHigh ? 'w-[100%] bg-rose-500 shadow-[0_0_10px_rgba(244,63,94,0.5)]' :
                                                'w-[65%] bg-[#06b6d4] shadow-[0_0_10px_rgba(0,255,163,0.5)]'
                                            }`} />
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="text-2xl font-black italic leading-none" style={{ color: 'var(--text-primary)' }}>
                                                {coupon.totalOdd}<span className="text-[#06b6d4] text-base ml-1">x</span>
                                            </div>
                                        </div>

                                        {/* Animated CTA */}
                                        <div className="flex-1 flex justify-center px-4">
                                            <div className="px-4 py-2 bg-[#06b6d4]/10 rounded-full animate-pulse flex items-center gap-1.5">
                                                <Zap className="w-3 h-3 text-[#06b6d4]" />
                                                <span className="text-[9px] font-black text-[#06b6d4] tracking-widest uppercase">ANALİZ İÇİN TIKLA</span>
                                            </div>
                                        </div>
                ...
                <div className="mt-6 flex flex-col gap-3 animate-fade-in-up animate-delay-3">
                    <button className="w-full py-3 bg-[#06b6d4] text-black rounded-lg font-black text-[10px] uppercase tracking-widest hover:shadow-[0_8px_30px_rgba(0,255,163,0.3)] transition-all">
                        TÜM KUPONLARI GÖR
                    </button>
                    <button className="w-full py-3 rounded-lg font-black text-[10px] uppercase tracking-widest hover:text-[#06b6d4] transition-all text-zinc-400 bg-zinc-800/30 hover:bg-zinc-800/60">
                            ...
                            <div className="space-y-3">
                                {selectedCoupon.matches.map((match, idx) => (
                                    <div key={idx} className="rounded-lg p-5 relative overflow-hidden group bg-[#22262F]">
                                        {/* Background Glow */}
                                        <div className="absolute top-0 right-0 w-20 h-20 bg-[#06b6d4]/5 rounded-full blur-xl pointer-events-none" />
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center gap-1.5 pt-3">
                                            ...
                                            <div className="flex flex-wrap gap-1.5 w-full">
                                                {[
                                                    ...
                                                    <div key={bidx} className={`flex-1 min-w-[100px] flex items-center justify-between px-3 py-2 rounded transition-all ${bookie.isHighest ? 'bg-[#06b6d4]/10 shadow-[0_0_8px_rgba(0,255,163,0.15)] animate-pulse' : 'bg-[#0A0C10]'}`}>
                                                        <div className="flex items-center gap-1">
                                                            <span className="text-[9px] font-black" style={{ color: 'var(--text-primary)' }}>{bookie.name}</span>
                                                            {bookie.isHighest && <span className="text-[6px] bg-[#06b6d4] text-black px-0.5 rounded font-black">EN YÜKSEK</span>}
                                                        </div>
                                                        <span className={`text-[10px] font-black ${bookie.isHighest ? 'text-[#06b6d4]' : ''}`} style={bookie.isHighest ? {} : { color: 'var(--text-muted)' }}>{bookie.odds}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between bg-[#22262F]">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="hidden md:flex items-center gap-1 px-3 py-1.5 rounded bg-[#0A0C10]">
                                    ...
                                    <span className="text-[9px] font-black text-[#06b6d4] tracking-widest uppercase">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-lg font-black text-[#06b6d4]">{selectedCoupon.totalOdd}</p>
                            </div>
                        </div>
