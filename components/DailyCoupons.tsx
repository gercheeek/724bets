    ...
    return (
        <section id="daily-coupons" className="relative w-full bg-zinc-900/40 backdrop-blur-md rounded-lg p-4 md:p-6 h-full flex flex-col">
            ...
            <div className="flex overflow-x-auto gap-1.5 mb-3 pb-1 justify-start scrollbar-none animate-fade-in-up">
                <button
                    ...
                    className={`flex flex-col items-center justify-center min-w-[55px] h-[38px] rounded-lg transition-all duration-300 ${selectedDate === 'WEEKLY'
                        ? 'bg-[color:var(--theme-accent)] text-black shadow-[0_2px_10px_rgba(0,255,163,0.2)]'
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-[8px] font-black uppercase tracking-widest transition-all duration-300 shrink-0 ${
                            selectedCategory === cat
                                ? 'bg-[color:var(--theme-accent)] text-black shadow-[0_0_10px_rgba(0,255,163,0.15)]'
            ...
            {displayCoupons.length === 0 && (
                <div className="text-center py-12 rounded-lg animate-fade-in bg-[#0A0C10]">
            ...
            <div className="flex flex-col gap-4 flex-1">
                    ...
                    if (isLocked) {
                        return (
                                <div key={coupon.id} className="relative group" style={{ animationDelay: `${index * 0.1}s` }}>
                                    ...
                                    <div className="rounded-lg p-5 pointer-events-none bg-[#0A0C10]" style={{ filter: 'blur(4px)', userSelect: 'none', boxShadow: 'var(--shadow-card)' }}>
                                        <div className="flex items-center justify-between mb-3">
                                            <div className="flex gap-1.5 flex-wrap">
                                                <div className={`px-3 py-1 rounded-full text-[9px] font-black uppercase tracking-widest flex items-center gap-1.5 ${isLow ? 'bg-[#00E5FF]/10 text-[#00E5FF]' : isHigh ? 'bg-rose-500/10 text-rose-500' : 'bg-[color:var(--theme-accent)]/10 text-[color:var(--theme-accent)]'}`}>
                                        ...
                                        <div className="space-y-2 mb-3">
                                            {coupon.matches.slice(0, 3).map((m, i) => (
                                                <div key={i} className="flex items-center justify-between rounded-lg p-3 bg-[#22262F]">
                                                    ...
                                                    <span className="text-[color:var(--theme-accent)] text-xs font-black ml-2">{m.odd}</span>
                                                </div>
                                            ))}
                                        </div>
                                        <div className="flex justify-between items-center">
                                            <span style={{ color: 'var(--text-dim)', fontSize: '10px', fontWeight: 'bold' }}>TOPLAM ORAN</span>
                                            <span className="text-[color:var(--theme-accent)] text-sm font-black">{coupon.totalOdd}</span>
                                        </div>
                                    </div>
                                    {/* Lock Overlay */}
                                    <div className="absolute inset-0 rounded-lg flex flex-col items-center justify-center backdrop-blur-[2px]" style={{ background: 'color-mix(in srgb, var(--bg-card) 60%, transparent)' }}>
                                        <button
                                            ...
                                            className="flex items-center gap-2 px-5 py-2.5 bg-[color:var(--theme-accent)] text-black font-black text-xs rounded-full uppercase tracking-widest hover:bg-[color:var(--theme-accent)]/90 transition-all shadow-[0_0_20px_rgba(0,255,163,0.3)] hover:shadow-[0_0_30px_rgba(0,255,163,0.5)]"
                                        >
                        ...
                        return (
                            <div
                                ...
                                className="group relative rounded-lg p-5 transition-all duration-500 hover:scale-[1.03] animate-fade-in-up cursor-pointer bg-[#0A0C10] hover:bg-[#22262F]"
                                style={{ boxShadow: 'var(--shadow-card)', animationDelay: `${index * 0.1}s` }}
                            >
                                {/* Card Header / Badge */}
                                <div className="flex items-center justify-between mb-3 px-1">
                                    <div className="flex items-center gap-1.5 flex-wrap">
                                        <div className={`px-2 py-0.5 rounded-lg text-[8px] font-black uppercase tracking-widest flex items-center gap-1.5 ${isLow ? 'bg-[#00E5FF]/10 text-[#00E5FF]' :
                                            isHigh ? 'bg-rose-500/10 text-rose-500' :
                                                'bg-[color:var(--theme-accent)]/10 text-[color:var(--theme-accent)]'
                                            }`}>
                                    ...
                                    <div className="flex items-center gap-1">
                                        <div className="w-1 h-1 rounded-full bg-[color:var(--theme-accent)] animate-pulse" />
                                        ...
                                        <div key={midx} className="relative">
                                            <div className="flex flex-col gap-1">
                                                <div className="flex items-center justify-between">
                                                    ...
                                                    <span className="text-[color:var(--theme-accent)] font-black text-xs">{match.odd}</span>
                                                </div>
                                                <div className="flex items-center gap-1.5">
                                                    <div className="h-px w-4 bg-[color:var(--theme-accent)]/30 rounded-full" />
                                ...
                                <div className="mb-3 space-y-1.5">
                                    <div className="flex justify-between items-center text-[8px] font-black text-[#9CA3AF] uppercase tracking-widest">
                                        ...
                                        <span className={isLow ? 'text-[#00E5FF]' : isHigh ? 'text-rose-500' : 'text-[color:var(--theme-accent)]'}>
                                            {coupon.riskLevel}
                                        </span>
                                    </div>
                                    <div className="h-1 w-full bg-black/5 rounded-full overflow-hidden">
                                        <div className={`h-full rounded-full transition-all duration-1000 ${isLow ? 'w-[30%] bg-[#00E5FF] shadow-[0_0_10px_rgba(16,185,129,0.5)]' :
                                            isHigh ? 'w-[100%] bg-rose-500 shadow-[0_0_10px_rgba(244,63,94,0.5)]' :
                                                'w-[65%] bg-[color:var(--theme-accent)] shadow-[0_0_10px_rgba(0,255,163,0.5)]'
                                            }`} />
                                    </div>
                                </div>
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex flex-col">
                                            ...
                                            <div className="text-2xl font-black italic leading-none" style={{ color: 'var(--text-primary)' }}>
                                                {coupon.totalOdd}<span className="text-[color:var(--theme-accent)] text-base ml-1">x</span>
                                            </div>
                                        </div>

                                        {/* Animated CTA */}
                                        <div className="flex-1 flex justify-center px-4">
                                            <div className="px-4 py-2 bg-[color:var(--theme-accent)]/10 rounded-full animate-pulse flex items-center gap-1.5">
                                                <Zap className="w-3 h-3 text-[color:var(--theme-accent)]" />
                                                <span className="text-[9px] font-black text-[color:var(--theme-accent)] tracking-widest uppercase">ANALİZ İÇİN TIKLA</span>
                                            </div>
                                        </div>
                ...
                <div className="mt-6 flex flex-col gap-3 animate-fade-in-up animate-delay-3">
                    <button className="w-full py-3 bg-[color:var(--theme-accent)] text-black rounded-lg font-black text-[10px] uppercase tracking-widest hover:shadow-[0_8px_30px_rgba(0,255,163,0.3)] transition-all">
                        TÜM KUPONLARI GÖR
                    </button>
                    <button className="w-full py-3 rounded-lg font-black text-[10px] uppercase tracking-widest hover:text-[color:var(--theme-accent)] transition-all text-zinc-400 bg-zinc-800/30 hover:bg-zinc-800/60">
            ...
            {selectedCoupon && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-xl rounded-lg overflow-hidden shadow-2xl animate-fade-in-up bg-[#0A0C10]">

                        {/* Modal Header */}
                        <div className="flex items-center justify-between px-6 py-4 bg-[#22262F]">
                            <div className="flex items-center gap-2">
                                <div className="w-8 h-8 rounded-full bg-[color:var(--theme-accent)]/10 flex items-center justify-center">
                                    <Zap className="w-4 h-4 text-[color:var(--theme-accent)]" />
                                </div>
                                <div>
                                    ...
                                    <p className="text-[10px] font-bold uppercase flex items-center gap-1" style={{ color: 'var(--text-dim)' }}>
                                        <CheckCircle2 className="w-3 h-3 text-[#00E5FF]" /> %92 İstatistiksel Güven Score'u
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                {selectedCoupon.matches.map((match, idx) => (
                                    <div key={idx} className="rounded-lg p-5 relative overflow-hidden group bg-[#22262F]">
                                        {/* Background Glow */}
                                        <div className="absolute top-0 right-0 w-20 h-20 bg-[color:var(--theme-accent)]/5 rounded-full blur-xl pointer-events-none" />

                                        <div className="flex items-center justify-between mb-2">
                                            <div className="flex items-center gap-2">
                                                <div className="w-6 h-6 rounded flex items-center justify-center bg-[#0A0C10]">
                                            ...
                                            <div className="px-3 py-1 bg-[#00E5FF]/10 text-[#00E5FF] text-[10px] font-black rounded">
                                                {match.prediction}
                                            </div>
                                        </div>

                                        <div className="rounded p-4 mb-3 bg-[#0A0C10]/50">
                                        ...
                                        <div className="flex flex-col sm:flex-row items-center gap-1.5 pt-3">
                                            ...
                                            <div className="flex flex-wrap gap-1.5 w-full">
                                                {[
                                                    ...
                                                    <div key={bidx} className={`flex-1 min-w-[100px] flex items-center justify-between px-3 py-2 rounded transition-all ${bookie.isHighest ? 'bg-[color:var(--theme-accent)]/10 shadow-[0_0_8px_rgba(0,255,163,0.15)] animate-pulse' : 'bg-[#0A0C10]'}`}>
                                                        <div className="flex items-center gap-1">
                                                            <span className="text-[9px] font-black" style={{ color: 'var(--text-primary)' }}>{bookie.name}</span>
                                                            {bookie.isHighest && <span className="text-[6px] bg-[color:var(--theme-accent)] text-black px-0.5 rounded font-black">EN YÜKSEK</span>}
                                                        </div>
                                                        <span className={`text-[10px] font-black ${bookie.isHighest ? 'text-[color:var(--theme-accent)]' : ''}`} style={bookie.isHighest ? {} : { color: 'var(--text-muted)' }}>{bookie.odds}</span>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                        ...
                        <div className="px-6 py-4 flex items-center justify-between bg-[#22262F]">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="hidden md:flex items-center gap-1 px-3 py-1.5 rounded bg-[#0A0C10]">
                                    <User className="w-3 h-3" style={{ color: 'var(--text-dim)' }} />
                                    <span className="text-[9px] font-black text-[color:var(--theme-accent)] tracking-widest uppercase">
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-lg font-black text-[color:var(--theme-accent)]">{selectedCoupon.totalOdd}</p>
                            </div>
                        </div>
