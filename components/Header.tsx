              ...
              <div className="hidden lg:flex bg-[#0F1219] rounded-md p-0.5 border border-white/5 shadow-inner ml-2">
                ...
                <div className="relative group">
                  <button 
                    ...
                    className={`px-4 py-2 rounded-md text-sm font-bold transition-all flex items-center gap-1.5 ${(activeView === 'plinko' || activeView === 'originals') ? 'bg-[#1C2028] text-[#00FFA3] shadow-md' : 'text-zinc-400 hover:text-zinc-200 group-hover:bg-[#1C2028] group-hover:text-white'}`}
                  >
