    ...
    <div className="w-full pb-6 md:pb-6 mb-4 md:mb-0">
      <div className="w-full grid grid-cols-2 gap-0 h-[220px] sm:h-[300px] md:h-[240px] rounded-3xl md:rounded-none overflow-hidden md:overflow-visible shadow-[0_20px_60px_rgba(0,0,0,0.7)] md:shadow-none border border-white/10 md:border-none relative bg-transparent">
        ...
        >
          ...
          />
          {/* Gradient overlay: Dark on left for text, soft shadow on right to gently mask seam */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(0,0,0,0.9)_0%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.4)_100%)] md:bg-[linear-gradient(to_right,rgba(0,0,0,0.8)_0%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.3)_100%)] pointer-events-none group-hover:bg-[linear-gradient(to_right,rgba(0,0,0,0.7)_0%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.2)_100%)] transition-all duration-500"></div>
        ...
        >
          <img 
            ...
            className="absolute inset-0 w-full h-full object-cover transform md:group-hover:scale-105 transition-all duration-700 ease-out opacity-100"
          />
          {/* Gradient overlay: Dark on right for text, soft shadow on left to gently mask seam */}
          <div className="absolute inset-0 bg-[linear-gradient(to_left,rgba(0,0,0,0.9)_0%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.4)_100%)] md:bg-[linear-gradient(to_left,rgba(0,0,0,0.8)_0%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.3)_100%)] pointer-events-none group-hover:bg-[linear-gradient(to_left,rgba(0,0,0,0.7)_0%,rgba(0,0,0,0.1)_50%,rgba(0,0,0,0.2)_100%)] transition-all duration-500"></div>
