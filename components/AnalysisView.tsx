...
const AnalysisDrawer: React.FC<{
    ...
    return (
        <div
            className="overflow-hidden transition-all duration-500 relative bg-[#0A0C10]/50"
        ...
        >
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none" style={{ opacity: 0.04 }}>
                <svg viewBox="0 0 120 140" className="w-48 h-56" fill="none">
                    <path d="M60 10 L75 45 L110 50 L85 75 L92 110 L60 95 L28 110 L35 75 L10 50 L45 45 Z" fill="#06b6d4" />
                    <rect x="45" y="95" width="30" height="8" rx="2" fill="#06b6d4" />
                    <rect x="35" y="103" width="50" height="6" rx="2" fill="#06b6d4" />
                    <rect x="40" y="109" width="40" height="12" rx="3" fill="#06b6d4" />
                    <circle cx="60" cy="52" r="12" fill="none" stroke="#06b6d4" strokeWidth="2" />
                    <path d="M54 48 L54 56 L66 52 Z" fill="#06b6d4" />
                </svg>
            </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            {isLoggedIn ? (
                                ...
                                <div className="relative">
                                    <p className="text-gray-300 text-[13px] leading-relaxed italic pl-6 ml-1.5 bg-[#0A0C10]/40 p-3 rounded" style={{ filter: 'blur(5px)', userSelect: 'none' }}>
                                        {analysis.bettingScenario}
                                    </p>
                        ...
                        <>
                            ...
                            <div className="space-y-2">
                                {analysis.bookieOdds.map((bookie, bidx) => (
                                    <div key={bidx} className={`p-4 rounded-lg transition-colors ${bookie.isHighest ? 'bg-[#22262F] shadow-[0_0_15px_rgba(0,255,163,0.05)]' : 'bg-[#0A0C10] hover:bg-[#22262F]'}`}>
        ...
        <div className="w-full min-h-screen font-sans pb-24 relative" style={{ background: '#000000', color: '#e2e8f0' }}>
            ...
            <div className="max-w-[900px] mx-auto px-4 py-4 relative z-10">
                ...
                <div className="mb-6 rounded-lg overflow-hidden relative shadow-[0_0_30px_rgba(0,255,163,0.05)]" style={{ background: 'linear-gradient(135deg, rgba(26,21,0,0.8) 0%, rgba(10,13,20,0.9) 100%)' }}>
                    <div className="absolute right-0 top-0 bottom-0 w-1/2 opacity-20 bg-no-repeat bg-right-bottom" style={{ backgroundImage: 'radial-gradient(circle at right, #06b6d4 0%, transparent 70%)' }}></div>
                    <div className="p-4 sm:p-5 flex items-center justify-between relative z-10">
                        ...
                        <div className="hidden sm:block text-right">
                            ...
                            <p className="text-xs font-black text-[#00E5FF]">%88 Başarı Oranı</p>
                        </div>
                    </div>
                </div>
                                ...
                                <div className="space-y-2">
                                    {matches.map((analysis, idx) => {
                                                    ...
                                                    <div className="flex flex-col md:flex-row md:items-center justify-between p-6 gap-4 select-none" style={{ filter: 'blur(4px)', userSelect: 'none' }}>
                                                        ...
                                                        <div className="flex items-center gap-2 shrink-0">
                                                            <div className="px-4 py-2 rounded-lg text-center min-w-[60px]" style={{ background: '#111111' }}>
                                                                ...
                                                                <span className="text-xs font-black text-[#00E5FF]">%{analysis.confidence}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {/* Lock overlay */}
                                        ...
                                        return (
                                            <div
                                                key={analysis.id}
                                                className={`relative rounded-lg overflow-hidden transition-all duration-200 ${isExpanded ? 'bg-[#22262F] shadow-[0_0_25px_rgba(0,255,163,0.1)]' : 'bg-[#0A0C10] hover:bg-[#22262F] shadow-[0_0_15px_rgba(0,255,163,0.03)]'}`}
                                            >
                                                {/* Main Row */}
                                                <div
                                                ...
                                                >
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-2.5 flex-1 min-w-0">
                                                        ...
                                                        {analysis.confidence >= 88 && (
                                                            <span className="text-[9px] font-extrabold px-2 py-0.5 rounded-full flex items-center gap-1 shrink-0" style={{ background: '#06b6d4', color: '#000000' }}>
                                                    ...
                                                    <div className="flex items-center gap-2 shrink-0">
                                                        <div className="px-4 py-2 rounded-lg text-center min-w-[70px]" style={{ background: '#111111' }}>
                                                            ...
                                                            <span className="text-[11px] font-black text-[#00E5FF]">{analysis.prediction}</span>
                                                        </div>
                                                    ...
                                                    <div className="flex items-center gap-2.5 shrink-0">
                                                        <span className="flex items-center gap-1 text-[10px] font-extrabold px-2.5 py-1.5 rounded-lg uppercase tracking-wider bg-[#00E5FF]/10 border border-[#00E676]/30 text-[#00E5FF]">
