  ...
  return (
    <div className="min-h-screen bg-[#0B0E14] flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-[#00FFA3]/10 rounded-full blur-[120px]" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#00FFA3]/5 rounded-full blur-[100px]" />
      </div>
      ...
      <div className="z-10 flex flex-col items-center max-w-2xl text-center">
        ...
        <div className="mb-12 relative group cursor-default">
          <div className="flex items-center">
            ...
            <span className="logo-dot text-6xl md:text-8xl mx-[4px] leading-none mb-4 font-black" style={{ color: '#00FFA3' }}>.</span>
        ...
        <div className="bg-[#151921] border border-[#2A2E3D] rounded-2xl p-8 md:p-12 shadow-2xl relative overflow-hidden">
          ...
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 bg-[#00FFA3]/10 rounded-2xl flex items-center justify-center animate-pulse">
              <Hammer className="w-8 h-8 text-[#00FFA3]" />
            </div>
          </div>
          ...
          <div className="mt-8 pt-8 border-t border-white/5">
            <div className="inline-flex items-center gap-3 bg-[#0f141c] px-6 py-3 rounded-full border border-white/5">
              <div className="w-3 h-3 bg-[#00FFA3] rounded-full animate-pulse shadow-[0_0_10px_rgba(0,255,163,0.8)]"></div>
