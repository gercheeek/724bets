...
const WorldCupTeaser: React.FC<WorldCupTeaserProps> = ({ onMatchClick, children }) => {
  return (
    <div className="w-full flex flex-col gap-4 my-6 font-sans">
      
      {/* HERO BANNER */}
      <div className="w-full rounded-2xl overflow-hidden relative flex flex-col md:flex-row items-center md:items-stretch min-h-[300px] md:min-h-[160px]" 
        ...
        {/* Content Container */}
        <div className="relative z-10 flex flex-col items-center md:items-start text-center md:text-left w-full p-6 md:p-8 lg:px-10 justify-center">
          
          {/* Title */}
          <h2 className="text-white text-[28px] md:text-3xl lg:text-[34px] font-bold tracking-tight mb-5 md:mb-6 leading-tight drop-shadow-md">
            En iyi <span className="text-[#00FFA3]">Dünya Kupası Oranları!</span>
          </h2>

          {/* Action Row */}
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-4 mb-6 md:mb-5 w-full md:w-auto">
          ...
          {/* Stats */}
          <div className="bg-[#181A24]/70 backdrop-blur-md border border-white/5 rounded-lg px-4 md:px-5 py-2.5 text-center">
