...
const WorldCupTeaser: React.FC<WorldCupTeaserProps> = ({ onClick }) => {
  return (
    <div 
      className="w-full bg-[#1A1C24] rounded-xl overflow-hidden cursor-pointer hover:ring-2 ring-emerald-500/50 transition-all shadow-xl group my-8 font-sans"
      onClick={onClick}
    >
      {/* HEADER */}
      ...
      {/* TABS */}
      <div className="bg-[#1D1F2A] px-2 py-2 flex items-center gap-1 overflow-x-auto border-b border-[#2C2F3D]">
      ...
      <div className="p-4 sm:p-6 bg-[#181A22]">
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
            ...
            {/* MATCH CARD 1 */}
            <div className="bg-[#1E202B] rounded-xl p-4 min-w-[320px] shrink-0 border border-[#2C2F3D]">
