        ...
        <div className="p-4 sm:p-6 text-white h-full flex flex-col relative overflow-y-auto bg-[#050608]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 mb-4">
                <button 
                    ...
                    className={`text-left bg-[#0b0c10] border transition-all rounded-lg p-3 shadow-md relative overflow-hidden group ${activeMetric === 'pnl' ? 'border-[#00ff88]/50 shadow-[0_0_15px_rgba(0,255,136,0.15)] bg-[#00ff88]/5' : 'border-white/5 hover:border-[#00ff88]/30'}`}
                >
                    ...
                    <div className="flex justify-between items-start mb-2 relative z-10">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-wider">Günlük Net PNL</p>
                        <TrendingUp className={`w-3.5 h-3.5 ${activeMetric === 'pnl' ? 'text-[#00ff88] animate-pulse' : 'text-zinc-600'}`} />
                    </div>
                    <div className="flex items-end gap-2 relative z-10">
                        <h3 className="text-xl font-black text-white font-mono">₺165,420</h3>
                        <span className="text-[#00ff88] text-[10px] font-bold flex items-center mb-0.5"><ArrowUpRight className="w-2.5 h-2.5" /> 12.5%</span>
                    </div>
                </button>

                <button 
                    onClick={() => setActiveMetric('risk')}
                    className={`text-left bg-[#0b0c10] border transition-all rounded-lg p-3 shadow-md relative overflow-hidden group ${activeMetric === 'risk' ? 'border-[#ef4444]/50 shadow-[0_0_15px_rgba(239,68,68,0.15)] bg-[#ef4444]/5' : 'border-white/5 hover:border-[#ef4444]/30'}`}
                >
                    <svg className="absolute bottom-0 left-0 w-full h-1/2 opacity-20 group-hover:opacity-40 transition-opacity" viewBox="0 0 100 20" preserveAspectRatio="none">
                    ...
                    <div className="flex justify-between items-start mb-2 relative z-10">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-wider">Aktif Risk Yükü</p>
                        <ShieldAlert className={`w-3.5 h-3.5 ${activeMetric === 'risk' ? 'text-[#ef4444] animate-pulse' : 'text-zinc-600'}`} />
                    </div>
                    <div className="flex items-end gap-2 relative z-10">
                        <h3 className="text-xl font-black text-white font-mono">₺45,200</h3>
                        <span className="text-[#ef4444] text-[10px] font-bold flex items-center mb-0.5"><ArrowUpRight className="w-2.5 h-2.5" /> 5.2%</span>
                    </div>
                </button>

                <button 
                    onClick={() => setActiveMetric('players')}
                    className={`text-left bg-[#0b0c10] border transition-all rounded-lg p-3 shadow-md relative overflow-hidden group ${activeMetric === 'players' ? 'border-[#3b82f6]/50 shadow-[0_0_15px_rgba(59,130,246,0.15)] bg-[#3b82f6]/5' : 'border-white/5 hover:border-[#3b82f6]/30'}`}
                >
                    <svg className="absolute bottom-0 left-0 w-full h-1/2 opacity-20 group-hover:opacity-40 transition-opacity" viewBox="0 0 100 20" preserveAspectRatio="none">
                    ...
                    <div className="flex justify-between items-start mb-2 relative z-10">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-wider">Aktif Oyuncu</p>
                        <Users className={`w-3.5 h-3.5 ${activeMetric === 'players' ? 'text-[#3b82f6] animate-pulse' : 'text-zinc-600'}`} />
                    </div>
                    <div className="flex items-end gap-2 relative z-10">
                        <h3 className="text-xl font-black text-white font-mono">1,204</h3>
                        <span className="text-zinc-400 text-[10px] font-bold mb-0.5">Anlık</span>
                    </div>
                </button>

                <div className="bg-[#0b0c10] border border-white/5 hover:border-[#eab308]/30 transition-colors rounded-lg p-3 shadow-md relative overflow-hidden group">
                    <svg className="absolute bottom-0 left-0 w-full h-1/2 opacity-20 group-hover:opacity-40 transition-opacity" viewBox="0 0 100 20" preserveAspectRatio="none">
                    ...
                    <div className="flex justify-between items-start mb-2 relative z-10">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-wider">Bekleyen İşlem</p>
                        <Zap className="w-3.5 h-3.5 text-[#eab308]" />
                    </div>
                    <div className="flex items-end gap-2 relative z-10">
                        <h3 className="text-xl font-black text-white font-mono">3</h3>
                        <span className="text-zinc-400 text-[10px] font-bold mb-0.5">Manuel Onay</span>
                    </div>
                </div>
                
                <div className="bg-[#0b0c10] border border-white/5 hover:border-[#10b981]/30 transition-colors rounded-lg p-3 shadow-md relative overflow-hidden group">
                    <div className="flex justify-between items-start mb-2">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-wider">Ort. Çekim Onayı</p>
                        <TrendingUp className="w-3.5 h-3.5 text-[#10b981]" />
                    </div>
                    <div className="flex items-end gap-2">
                        <h3 className="text-xl font-black text-white font-mono">4.2<span className="text-sm">dk</span></h3>
                        <span className="text-[#10b981] text-[10px] font-bold mb-0.5">SLA: HARİKA</span>
                    </div>
                </div>

                <div className="bg-[#0b0c10] border border-white/5 hover:border-[#8b5cf6]/30 transition-colors rounded-lg p-3 shadow-md relative overflow-hidden group">
                    <div className="flex justify-between items-start mb-2">
                        <p className="text-zinc-500 text-[10px] font-black uppercase tracking-wider">Canlı Destek Sırası</p>
                        <Users className="w-3.5 h-3.5 text-[#8b5cf6]" />
                    </div>
                    <div className="flex items-end gap-2">
                        <h3 className="text-xl font-black text-white font-mono">12</h3>
                        <span className="text-zinc-400 text-[10px] font-bold mb-0.5">Ort. Bekleme: 1.5dk</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 flex-1 min-h-[400px]">
                ...
                {/* Dynamic Chart */}
                <div className="lg:col-span-2 bg-[#0b0c10] border border-white/5 rounded-lg p-4 shadow-lg flex flex-col relative">
                    
                    <div className="flex items-center justify-between mb-4">
                        <h3 className="text-zinc-400 text-xs font-black uppercase tracking-wider">
                            {activeMetric === 'pnl' && 'Net PNL Eğrisi (Son 12 Saat)'}
                            {activeMetric === 'risk' && 'Aktif Risk Yükü (Son 12 Saat)'}
                            {activeMetric === 'players' && 'Oyuncu Trafiği (Son 12 Saat)'}
                        </h3>
                        <div className="flex gap-2 text-[9px] font-bold">
                            <button className="bg-white/10 text-white px-2 py-1 rounded">12S</button>
                            <button className="text-zinc-500 hover:text-white px-2 py-1">24S</button>
                            <button className="text-zinc-500 hover:text-white px-2 py-1">7G</button>
                        </div>
                    </div>
                ...
                {/* Live Activity Feed */}
                <div className="bg-[#0b0c10] border border-white/5 rounded-lg p-4 shadow-lg flex flex-col overflow-hidden">
                    <div className="flex items-center justify-between mb-3">
                        <h3 className="text-zinc-400 text-[10px] font-black uppercase tracking-wider flex items-center gap-2">
                            <span className="w-1.5 h-1.5 rounded-full bg-[#00ff88] animate-pulse shadow-[0_0_8px_rgba(0,255,136,0.6)]"></span>
                            Canlı İşlem Akışı
                        </h3>
                        <div className="flex gap-1">
                            <button className="text-[8px] bg-white/5 hover:bg-white/10 px-1.5 py-1 rounded text-zinc-300 transition-colors">TÜMÜ</button>
                            <button className="text-[8px] bg-white/5 hover:bg-white/10 px-1.5 py-1 rounded text-[#eab308] transition-colors">UYARI</button>
                        </div>
                    </div>
