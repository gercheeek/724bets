...
const EnhancedBetting: React.FC = () => {
  const gamdomLink = 'https://gamdom.com/r/724bets';
    ...
    <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <a 
          ...
          className="relative rounded-lg overflow-hidden group cursor-pointer border border-[#f2a900]/20 hover:border-[#f2a900]/50 transition-all duration-300 shadow-lg hover:shadow-[0_0_30px_rgba(242,169,0,0.15)] aspect-[21/9] bg-[#0A0C10]"
        >
        ...
        >
          ...
          <div className="absolute inset-0 flex flex-col justify-center p-6 sm:p-8 z-20">
            ...
            <p className="text-gray-400 text-xs sm:text-sm font-bold mb-4 max-w-[200px] sm:max-w-[250px]">
              724bets referansıyla katılanlara özel ekstra rakeback ve promosyonlar.
            </p>
