...
import { generateLiveWins } from '../utils/liveWinsData';

const LiveWinsMarquee: React.FC = () => {
    // We memoize the generated wins so they don't regenerate on every render
    const wins = useMemo(() => generateLiveWins(250), []);
