      ...
      <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 pt-6 sm:pt-12 relative z-10">
        <div className="flex flex-col items-center justify-center text-center space-y-3 sm:space-y-4 mb-8 sm:mb-12">
          <div className="w-16 h-16 sm:w-24 sm:h-24 bg-[#111317] rounded-2xl flex items-center justify-center border border-white/5 shadow-[0_0_40px_rgba(0,0,0,0.5)] group relative">
            <div className="absolute inset-0 bg-gradient-to-tr from-[#06b6d4]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl" />
            <Ticket className="w-8 h-8 sm:w-12 sm:h-12 text-[#06b6d4] drop-shadow-[0_0_15px_rgba(0,255,163,0.5)] transform group-hover:scale-110 transition-transform duration-500" />
          </div>
          <h1 className="text-3xl sm:text-5xl font-black text-white uppercase tracking-tight drop-shadow-xl mt-4">Kodu <span className="text-[#06b6d4] drop-shadow-[0_0_20px_rgba(0,255,163,0.4)]">Kullan</span></h1>
        ...
        <div className="max-w-md mx-auto bg-[#111317] border border-white/5 p-6 sm:p-8 rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.8)] relative overflow-hidden group/form">
          <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#06b6d4]/30 to-transparent group-hover/form:via-[#06b6d4]/80 transition-all duration-700"></div>
            ...
            <div>
              ...
              <div className="relative group">
                  <input 
                    ...
                    className="w-full bg-[#0A0C10] border-2 border-white/5 focus:border-[#06b6d4]/50 focus:shadow-[0_0_20px_rgba(0,255,163,0.15)] rounded-2xl py-3.5 sm:py-4 px-4 text-white text-base sm:text-lg font-black tracking-[0.2em] text-center transition-all outline-none placeholder:text-zinc-700"
                  />
                  <div className="absolute inset-0 rounded-2xl bg-[#06b6d4]/5 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-300"></div>
              </div>
            </div>
            ...
            {promos.map((promo, idx) => (
              <div key={idx} className="flex gap-4 relative group cursor-pointer p-4 rounded-2xl hover:bg-white/5 transition-colors border border-transparent hover:border-white/5">
                <div className="w-[100px] h-[100px] shrink-0 bg-gradient-to-br from-[#2A313C] to-[#1A1F27] rounded-3xl flex items-center justify-center shadow-[0_8px_30px_rgba(0,0,0,0.4)] border border-white/5 relative overflow-hidden group-hover:scale-105 transition-transform duration-300">
                  <div className="absolute inset-0 bg-gradient-to-tr from-[#06b6d4]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
                  {promo.icon}
                </div>
                <div className="flex flex-col pt-1">
                  <h3 className="text-white font-bold text-sm sm:text-base leading-tight mb-2 group-hover:text-[#06b6d4] transition-colors">{promo.title}</h3>
