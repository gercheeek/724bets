...
export const SportsHeroBanner: React.FC = () => {
  return (
    <div className="w-full relative px-4 pt-4 pb-2 group">
      <div className="w-full h-[280px] md:h-[340px] lg:h-[400px] rounded-2xl bg-[#050505] relative overflow-hidden shadow-[0_15px_40px_rgba(0,0,0,0.8)] border border-white/[0.05] group/banner">
        ...
        {/* Center Content Area */}
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 pt-4 pb-6 px-4">
          
          {/* Top Tag */}
          <div className="px-5 py-1.5 rounded-full bg-[#10b981]/10 border border-[#10b981]/30 backdrop-blur-md mb-4 shadow-[0_0_20px_rgba(16,185,129,0.2)] animate-fade-in-up">
            <span className="text-[#10b981] font-black text-[10px] md:text-[13px] tracking-[0.3em] uppercase">Günün Dev Maçı</span>
          </div>

          {/* Aggressive Typography */}
          <h1 className="text-white font-black italic text-5xl md:text-6xl lg:text-[80px] uppercase tracking-tighter drop-shadow-[0_10px_20px_rgba(0,0,0,0.9)] text-center mb-0 leading-none animate-fade-in-up" style={{ animationDelay: '100ms' }}>
            İSPANYA <span className="text-[#10b981] mx-1 md:mx-4 text-4xl md:text-5xl lg:text-[60px] drop-shadow-[0_0_15px_rgba(16,185,129,0.5)]">VS</span> ARJANTİN
          </h1>
          <h2 className="text-gray-400 font-black text-sm md:text-xl tracking-[0.4em] uppercase mt-4 mb-10 md:mb-14 drop-shadow-lg animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            DÜNYA KUPASI FİNALİ
          </h2>

          {/* Dynamic Odds Buttons (Glassmorphism) */}
          <div className="flex items-center justify-center gap-2 md:gap-4 w-full max-w-[650px] animate-fade-in-up" style={{ animationDelay: '300ms' }}>
             {[
               ...
               >
                 ...
                 <span className="text-gray-400 group-hover/odd:text-[#36ffc4] font-black text-[9px] md:text-xs uppercase tracking-widest transition-colors relative z-10">{btn.label}</span>
                 <span className="text-white font-black text-base md:text-xl tracking-wide relative z-10">{btn.odd}</span>
               </button>
             ))}
          </div>
