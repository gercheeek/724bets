    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 bg-black/60 backdrop-blur-md animate-fade-in">
      <div className="bg-zinc-950 border border-zinc-800/80 rounded-[2rem] w-full max-w-md relative shadow-2xl overflow-hidden">
        ...
        <div className="p-8 relative z-10">
          ...
          {/* Method Tabs */}
          <div className="flex gap-2 p-1 bg-zinc-900 rounded-xl mb-8 border border-zinc-800/50">
            <button
          ...
          <div className="bg-zinc-900/40 border border-zinc-800/60 rounded-2xl p-5 mb-8 backdrop-blur-sm">
            {method === 'bank' ? (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex items-center justify-between bg-black/50 p-3 rounded-xl border border-zinc-800/80">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <input 
                  ...
                  className="w-full bg-zinc-900/80 border border-zinc-800 text-white rounded-xl pl-4 pr-12 py-3.5 focus:outline-none focus:border-blue-500 transition-colors font-medium text-lg placeholder-zinc-700"
                  placeholder="0.00"
                />
            ...
            <div>
              ...
              <input 
                ...
                className="w-full bg-zinc-900/80 border border-zinc-800 text-white rounded-xl px-4 py-3.5 focus:outline-none focus:border-blue-500 transition-colors font-medium placeholder-zinc-700"
            ...
            <button 
              ...
              className="w-full bg-blue-600 hover:bg-blue-500 text-white font-black py-4 rounded-xl transition-all mt-4 disabled:opacity-50 flex items-center justify-center gap-2 group shadow-[0_0_20px_rgba(37,99,235,0.2)] hover:shadow-[0_0_25px_rgba(37,99,235,0.4)]"
            >
