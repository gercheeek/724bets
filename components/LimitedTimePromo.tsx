    ...
    <div className="w-full relative overflow-hidden rounded-xl bg-[#0B0E14] border border-[#FF3366]/30 p-1 mb-4 shadow-[0_0_20px_rgba(255,51,102,0.1)] group transition-all duration-500 hover:shadow-[0_0_30px_rgba(255,51,102,0.2)]">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4 px-4 py-3">
        ...
        <div className="flex items-center gap-4 w-full md:w-auto justify-center md:justify-end shrink-0 mt-2 md:mt-0">
          {/* Stylish Minimal Timer */}
          <div className="flex items-center justify-center bg-[#0B0E14]/90 border border-white/10 rounded-full px-5 py-2.5 backdrop-blur-md shadow-[inset_0_0_15px_rgba(0,0,0,0.8)]">
            <div className="flex items-center gap-2.5 text-white font-mono font-black tracking-widest text-lg md:text-xl" style={{ textShadow: '0 0 10px rgba(255,255,255,0.3)' }}>
              <div className="w-2 h-2 rounded-full bg-[#FF3366] animate-pulse shadow-[0_0_8px_#FF3366]"></div>
