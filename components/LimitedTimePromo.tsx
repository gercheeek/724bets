    ...
    <>
      <div className="w-full relative overflow-hidden rounded-2xl bg-[#0F121A] border border-[#2A2E3D] p-1 mb-6 shadow-xl group transition-all duration-500">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden rounded-[14px]">
          ...
          {/* Subtle Green Glow */}
          <div className="absolute right-0 top-0 md:w-1/2 w-1/3 h-full bg-[color:var(--theme-accent)]/10 blur-[120px] pointer-events-none"></div>
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-4 w-full md:w-auto text-center md:text-left">
          <div className="flex flex-col justify-center">
            <div className="flex items-center justify-center md:justify-start gap-3 mb-1.5">
              <Sparkles className="w-6 h-6 text-[color:var(--theme-accent)] drop-shadow-[0_0_8px_rgba(0,255,163,0.5)]" />
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-center md:justify-end shrink-0">
          ...
          <div className="relative">
            <input 
              ...
              className="bg-[#0A0C10] border border-[#2A2E3D] text-white placeholder-[#848B9D] text-[13px] font-bold tracking-widest uppercase rounded-lg px-5 py-3.5 w-[200px] focus:outline-none focus:border-[color:var(--theme-accent)] focus:shadow-[0_0_15px_rgba(0,255,163,0.15)] transition-all"
            />
          </div>
        ...
        <div className="bg-[#0A0C10] border border-[#2A2E3D] rounded-2xl p-6 w-full max-w-md relative shadow-2xl animate-in fade-in zoom-in duration-300">
          ...
          <div className="space-y-4 text-sm text-[#848B9D]">
            ...
            <ul className="list-disc pl-5 space-y-3">
              ...
              <li>
                <strong className="text-white">Oyun Özgürlüğü:</strong> Bonusunuzu ve ana paranızı kısıtlama olmaksızın <strong className="text-[color:var(--theme-accent)]">tüm Slot ve Canlı Casino</strong> oyunlarında esnek bir şekilde kullanabilirsiniz.
              </li>
              <li>
                <strong className="text-white">Hedef & Çekim:</strong> Karmaşık çevrim şartları yoktur! Toplam bakiyenizi oyunlara katılarak <strong className="text-white">10.000₺</strong>'ye ulaştırdığınız an, doğrudan <strong className="text-[color:var(--theme-accent)]">5.000₺ NAKİT ÇEKİM</strong> yapabilirsiniz. (Çekim sonrası kalan bakiye sistem tarafından sıfırlanır).
              </li>
              <li>
          ...
          <div className="mt-8 flex gap-3">
            ...
            <button 
              ...
              className="flex-1 bg-[color:var(--theme-accent)] hover:bg-[#00E5FF] text-[#0F121A] font-black py-3 rounded-xl shadow-[0_0_20px_rgba(0,255,163,0.3)] transition-colors"
            >
              Kabul Et
            </button>
          </div>
