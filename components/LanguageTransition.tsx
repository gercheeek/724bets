  ...
  return (
    ...
    >
      <div className="relative flex flex-col items-center justify-center">
        {/* Glow behind text */}
        <div className="absolute inset-0 bg-[color:var(--theme-accent)] blur-[120px] opacity-25 rounded-full scale-150 animate-pulse" />
        ...
        <div className={`transform transition-all duration-700 cubic-bezier(0.34, 1.56, 0.64, 1) ${visible ? 'scale-110 translate-y-0 opacity-100' : 'scale-75 translate-y-12 opacity-0'}`}>
          <span className="flex items-center text-[60px] md:text-[90px] font-black font-['Outfit'] tracking-tighter text-[color:var(--theme-accent)] drop-shadow-[0_0_25px_rgba(0,255,163,0.35)] select-none lowercase">
            724bets
            <div className="flex items-center justify-center w-8 h-8 md:w-12 md:h-12 rounded-full border-[4px] md:border-[6px] border-[color:var(--theme-accent)] ml-3 -mt-16 md:-mt-24">
