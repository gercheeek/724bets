...
const Footer: React.FC = () => {
  return (
    <footer className="w-full bg-[#07090C] border-t border-white/5 py-10 md:py-16 mt-auto font-sans relative z-10">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-2">Ödeme Yöntemleri</h3>
            <div className="flex flex-wrap gap-2 sm:gap-3">
              {/* Crypto */}
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-3 py-2 flex items-center justify-center hover:border-[#F7931A]/50 transition-colors group">
                <img src="https://cryptologos.cc/logos/bitcoin-btc-logo.svg?v=029" alt="Bitcoin" className="h-5 sm:h-6 w-auto group-hover:scale-110 transition-transform" />
              </div>
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-3 py-2 flex items-center justify-center hover:border-[#627EEA]/50 transition-colors group">
                <img src="https://cryptologos.cc/logos/ethereum-eth-logo.svg?v=029" alt="Ethereum" className="h-5 sm:h-6 w-auto group-hover:scale-110 transition-transform" />
              </div>
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-3 py-2 flex items-center justify-center hover:border-[#26A17B]/50 transition-colors group">
                <img src="https://cryptologos.cc/logos/tether-usdt-logo.svg?v=029" alt="Tether" className="h-5 sm:h-6 w-auto group-hover:scale-110 transition-transform" />
              </div>
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-3 py-2 flex items-center justify-center hover:border-[#FF0013]/50 transition-colors group">
                <img src="https://cryptologos.cc/logos/tron-trx-logo.svg?v=029" alt="Tron" className="h-5 sm:h-6 w-auto group-hover:scale-110 transition-transform" />
              </div>
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-3 py-2 flex items-center justify-center hover:border-[#F3BA2F]/50 transition-colors group">
                <img src="https://cryptologos.cc/logos/bnb-bnb-logo.svg?v=029" alt="Binance Coin" className="h-5 sm:h-6 w-auto group-hover:scale-110 transition-transform" />
              </div>
              {/* Fiat/Bank */}
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-4 py-2 flex items-center justify-center hover:border-blue-500/30 transition-colors">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/2560px-Visa_Inc._logo.svg.png" alt="Visa" className="h-3 sm:h-4 w-auto brightness-200 grayscale" />
              </div>
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-4 py-2 flex items-center justify-center hover:border-red-500/30 transition-colors">
                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2a/Mastercard-logo.svg/1280px-Mastercard-logo.svg.png" alt="Mastercard" className="h-4 sm:h-5 w-auto" />
              </div>
              <div className="bg-[#11141D] border border-white/5 rounded-lg px-4 py-2 flex items-center justify-center hover:border-green-500/30 transition-colors">
                <span className="text-white font-bold text-[10px] sm:text-xs tracking-wider">HAVALE / EFT</span>
              </div>
            </div>
            
            {/* Providers */}
            <h3 className="text-white font-bold text-sm uppercase tracking-wider mt-4 mb-2">Güvenilir Sağlayıcılar</h3>
          ...
          <div className="flex flex-col gap-4 lg:items-end lg:text-right">
            <h3 className="text-white font-bold text-sm uppercase tracking-wider mb-2">Sorumlu Oyun</h3>
