      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-4 lg:col-span-2">
            ...
            {/* Providers */}
            <h3 className="text-white font-bold text-sm uppercase tracking-wider mt-4 mb-2 font-['Outfit']">{t("trusted_providers")}</h3>
        ...
        <div className="flex flex-col md:flex-row items-center justify-between pt-6 border-t border-white/5 text-[11px] sm:text-xs text-gray-600 gap-4">
          ...
          <div className="flex flex-col items-center md:items-end gap-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[9px] sm:text-[10px] text-zinc-500 font-mono tracking-wider">724bets v2.0.1</span>
            </div>
            <button 
