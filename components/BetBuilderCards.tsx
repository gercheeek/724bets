    ...
    <div className="w-full bg-[#12161E] border-y border-[#202532] flex flex-col mb-4">
      ...
      <div className="flex overflow-x-auto gap-4 p-4 px-6 custom-scrollbar">
        {cards.map((card) => (
          <div 
            key={card.id} 
            className={`relative min-w-[300px] max-w-[320px] bg-[#0A0C10] rounded-xl border border-transparent p-4 flex flex-col hover:bg-[#1E222A] cursor-pointer transition-all ${card.borderClass}`}
            style={{ 
