...
const AuthModal: React.FC<AuthModalProps> = ({ mode, onMemberLogin, onAdminLogin, onClose, hideMemberLogin = false, initialMemberMode = 'login' }) => {
    ...
    return (
        <div className="fixed inset-0 z-[20000] flex items-center justify-center bg-black/90 backdrop-blur-md p-4">
            <div className="w-full max-w-md bg-[#161616] rounded-xl overflow-hidden shadow-2xl relative p-6 border border-white/5">
                ...
                <div className="mb-6 flex items-center justify-center flex-col">
                    <div className="flex items-center">
                        <Club className="w-8 h-8 text-[#00FFA3] mr-2 drop-shadow-[0_0_10px_rgba(0,255,163,0.5)]" strokeWidth={2.5} />
                        <span style={{ fontSize: '24px', fontFamily: "'Outfit', sans-serif", fontWeight: 900, letterSpacing: '-1.5px', color: '#fff' }}>
                            724bets
                        </span>
                    </div>
                    {activeTab !== 'member' && (
                                ...
                                {memberMode === 'register' && (
                                    <>
                                        <div className="flex items-center gap-4 my-6">
                                            ...
                                            <span className="text-zinc-400 text-[13px] font-medium tracking-widest">VEYA</span>
                                            <div className="h-px bg-zinc-800 flex-1"></div>
                                        </div>

                                        <button className="w-full bg-[#2A2A2A] hover:bg-[#333333] text-white font-bold py-3.5 rounded transition-all text-[15px] flex items-center justify-center gap-3">
