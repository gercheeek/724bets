...
// --- NEW GAMES EXTRACTED FROM SLOTRA ---
  {
    ...
    category: 'new',
    rtp: '96.50%',
    customDemoUrl: 'https://demogamesfree.slanyywbug.net/gs2c/openGame.do?gameSymbol=vs10sleepdud&lang=en&cur=USD&lobbyUrl=https://launchgame2me.com/lobby/exit?redirect_url=https%3A%2F%2Fslotra.com&stylename=grplfm_slotra260&isGameUrlApiCalled=true&userId=None_USD',
    containImg: true
  },
  {
    id: 1200 + 1,
