      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-6">
        <div className="bg-[#12141a] border border-[#1f232b] rounded-xl p-6 shadow-xl">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-lg bg-[#06b6d4]/10 flex items-center justify-center border border-[#06b6d4]/20">
          ...
          <div className="space-y-5">
             <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  <input 
                    type="number" 
                    className="w-full h-12 bg-[#0a0c10] border border-[#2c313c] rounded-lg px-4 text-white font-bold focus:border-[#06b6d4] transition-colors outline-none"
             ...
             <button 
               ...
               className="w-full h-12 bg-[#06b6d4] hover:bg-[#00e693] text-black font-black rounded-lg transition-colors flex items-center justify-center gap-2"
             >
      ...
      <div className="w-full xl:w-1/3 flex flex-col gap-6">
         <div className="bg-[#12141a] border border-[#1f232b] rounded-xl p-6 shadow-xl h-full flex flex-col">
           <div className="flex items-center justify-between mb-4">
             ...
             <div className="flex items-center gap-2 text-[#06b6d4] bg-[#06b6d4]/10 px-3 py-1 rounded-full border border-[#06b6d4]/20">
                ...
                return Object.entries(grouped).map(([sportName, comps]) => {
                   ...
                   return (
                     <div key={sportName} className="flex flex-col border-b border-[#2c313c] last:border-0">
                       ...
                       >
                         <div className="flex items-center gap-3">
                           <div className="w-6 h-6 rounded-full bg-[#06b6d4]/20 text-[#06b6d4] flex items-center justify-center text-xs">⚽</div>
                           ...
                           {Object.entries(comps).map(([compName, evs]) => {
                              ...
                              return (
                                <div key={compName} className="flex flex-col border-t border-[#1f232b]">
                                  ...
                                  >
                                    <div className="flex items-center gap-2">
                                      <div className="w-5 h-5 rounded-full bg-[#10b981]/20 text-blue-400 flex items-center justify-center text-[10px]">🌍</div>
                                         ...
                                         return (
                                           <button 
                                             ...
                                             className={`w-full text-left p-2 rounded-lg border transition-all ${
                                               isSelected ? 'bg-[#10b981]/10 border-[#10b981]' : 'bg-[#12141a] border-[#1f232b] hover:border-[#424b5c]'
                                             }`}
                                           >
                                             <div className="flex justify-between items-center mb-1">
                                               <span className="text-[#06b6d4] text-[10px] font-bold">{ev.data?.minute ? `${ev.data.minute}'` : 'Canlı'}</span>
                                             </div>
             ...
             <>
               ...
               <div className={`space-y-5 ${!manualMode ? 'opacity-30 pointer-events-none' : ''}`}>
                 <div className="flex flex-col gap-2">
                    ...
                    <input 
                      type="number" 
                      className="w-full h-12 bg-[#0a0c10] border border-[#2c313c] rounded-lg px-4 text-[#06b6d4] font-black focus:border-[#FF1744] transition-colors outline-none"
                      value={manualMinute}
                      min="0" max="120"
