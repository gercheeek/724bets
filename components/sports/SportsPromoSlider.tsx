    ...
    return (
        <div className="w-full relative group/slider mb-4">
            <style>{`
                ...
                .title-gradient-blue {
                    background: linear-gradient(to bottom, #60a5fa 0%, #3730a3 100%);
                    -webkit-background-clip: text;
                    -webkit-text-fill-color: transparent;
                }
            `}</style>
            ...
            <div className="overflow-hidden rounded-xl relative w-full h-[160px] sm:h-[190px] md:h-[220px] bg-[#1a1c24] shadow-2xl cursor-pointer font-montserrat">
                ...
                >
                    ...
                    <div className="w-full h-full flex-shrink-0 relative overflow-hidden bg-[#0a0f1d]">
                        {/* Vertical Side Text */}
                        <div className="absolute left-0 top-0 bottom-0 w-8 bg-blue-900/10 flex items-center justify-center border-r border-white/5 z-20 backdrop-blur-sm">
                            <span className="vertical-text text-[10px] font-black text-blue-400/30 tracking-[0.3em] uppercase">724BETS PARTNERS</span>
                        </div>
                        ...
                        <div className="absolute top-0 right-0 w-[85%] md:w-[65%] h-full z-[2] overflow-hidden" style={{ maskImage: 'linear-gradient(to left, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 100%)', WebkitMaskImage: 'linear-gradient(to left, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 100%)' }}>
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-[#0a0f1d] via-[#0a0f1d]/70 to-blue-900/10 mix-blend-multiply"></div>
                        </div>
                        ...
                        <div className="absolute inset-0 z-10 flex flex-col justify-center px-12 md:px-16">
                            <div className={`${currentSlide === 0 ? 'anim-active' : ''}`}>
                                ...
                                {/* Badge */}
                                <div className="badge-anim inline-flex items-center gap-2 mb-2 bg-blue-500/10 border border-blue-500/20 px-2.5 py-1 rounded-sm">
                                    <div className="w-1.5 h-1.5 rounded-full bg-blue-500 shadow-[0_0_8px_#3b82f6]"></div>
                                    <span className="text-blue-400 font-bold text-[9px] md:text-[10px] tracking-[0.25em] uppercase">
                                        GLOBAL PARTNERSHIP
                                    </span>
                                </div>
                                ...
                                <h2 className="title-anim text-[28px] sm:text-[38px] md:text-[48px] font-black leading-[0.9] tracking-[-0.03em] italic uppercase drop-shadow-[0_4px_10px_rgba(0,0,0,0.5)] mb-2">
                                    ...
                                    <span className="title-gradient-blue">ESPORTS</span>
                                </h2>
                                
                                {/* Description */}
                                <div className="desc-anim border-l-[3px] border-blue-500/50 pl-3 md:pl-4 mt-2">
                    ...
                    <div className="w-full h-full flex-shrink-0 relative overflow-hidden bg-[#050b14]">
                        ...
                        {/* Vertical Side Text */}
                        <div className="absolute left-0 top-0 bottom-0 w-8 bg-blue-900/10 flex items-center justify-center border-r border-blue-500/10 z-20 backdrop-blur-sm">
                            <span className="vertical-text text-[10px] font-black text-blue-500/30 tracking-[0.3em] uppercase">HAFTANIN PROMOSU</span>
                        </div>
                        ...
                        <div className="absolute top-0 right-0 w-[85%] md:w-[65%] h-full z-[2] overflow-hidden" style={{ maskImage: 'linear-gradient(to left, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 100%)', WebkitMaskImage: 'linear-gradient(to left, rgba(0,0,0,1) 40%, rgba(0,0,0,0) 100%)' }}>
                            ...
                            <div className="absolute inset-0 bg-gradient-to-r from-[#050b14] via-[#050b14]/80 to-blue-900/40 mix-blend-multiply"></div>
                            <div className="absolute top-1/2 right-[10%] -translate-y-1/2 w-[400px] h-[400px] bg-blue-500/15 blur-[60px] rounded-full animate-pulse-glow pointer-events-none"></div>
                        </div>
                        <div className={`absolute inset-0 z-10 flex items-center px-12 md:px-16 ${currentSlide === 2 ? 'anim-active' : ''}`}>
                            <div className="w-full md:w-[60%] flex flex-col justify-center">
                                <div className="badge-anim inline-flex items-center gap-2 mb-2 bg-blue-500/10 border border-blue-500/20 px-2.5 py-1 rounded-sm w-fit">
                                    <div className="w-1.5 h-1.5 rounded-[1px] bg-blue-400 shadow-[0_0_8px_#60a5fa] rotate-45"></div>
                                    <span className="text-blue-500 font-bold text-[9px] md:text-[10px] tracking-[0.25em] uppercase">VİP KAZANÇ</span>
                                </div>
                                <h2 className="title-anim text-[28px] sm:text-[38px] md:text-[48px] font-black leading-[0.9] tracking-[-0.03em] italic uppercase drop-shadow-[0_4px_10px_rgba(0,0,0,0.5)] mb-2">
                                    <span className="title-gradient-white">KAZANCINI</span> <br className="hidden sm:block"/>
                                    <span className="title-gradient-blue">İKİYE KATLA</span>
                                </h2>
                                <div className="desc-anim border-l-[3px] border-blue-500/50 pl-3 md:pl-4 mt-2">
                                    <p className="text-gray-300 text-[11px] sm:text-[12px] md:text-[13px] max-w-[280px] sm:max-w-[350px] md:max-w-[420px] font-medium leading-snug tracking-wide">
                                        Favori takımınıza bahis yapın, maçı <strong className="text-blue-400 font-bold">2 gol farkla</strong> kazanırsanız, net kazancınızı anında 2'ye katlayalım!
                                    </p>
                                </div>
                            </div>
                            <div className="hidden md:flex graphic-anim w-[40%] h-full items-center justify-end pr-8">
                                <div className="relative flex items-center">
                                    ...
                                    <div className="flex flex-col gap-1 z-10 -ml-4 mt-6">
                                        <div className="w-12 h-1 bg-blue-500 shadow-[0_0_10px_#60a5fa] rounded-full"></div>
                                        <div className="text-blue-400 font-black text-[14px] tracking-[0.4em] uppercase leading-none">FREEBET</div>
