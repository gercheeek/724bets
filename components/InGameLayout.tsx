    ...
    <div className="flex flex-col h-screen w-full bg-[#05070A] text-white overflow-hidden font-sans">
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        <button 
          ...
          className={`hidden md:flex xl:hidden absolute left-0 top-1/2 -translate-y-1/2 z-30 p-2 bg-[#10b981]/20 border border-[#10b981]/50 hover:bg-[#10b981]/40 backdrop-blur-md rounded-r-xl transition-all shadow-[0_0_15px_rgba(59,130,246,0.5)] ${showLeftPanel && !isFullscreen ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
        >
        ...
        {/* Left Panel: Stats */}
        <aside className={`
          flex flex-col bg-[#0f172a]/80 backdrop-blur-xl border-r border-[#10b981]/15 hover:border-[#10b981]/30 overflow-y-auto transition-all duration-500 ease-in-out z-50
        ...
        `}>
           <div className="p-5 flex flex-col gap-6 relative">
                 ...
                 <div className="grid grid-cols-2 gap-2">
                    {[
                      ...
                      <button 
                        ...
                        className="text-left bg-[#05070A]/50 hover:bg-[#10b981]/20 border border-white/5 hover:border-[#10b981]/50 rounded-lg p-2 text-[10px] sm:text-xs font-bold text-gray-300 hover:text-white transition-all truncate"
                      >
                         {game.name}
                      </button>
                    ))}
              ...
              {/* Live Feed Widget */}
              <div className="bg-black/20 rounded-xl p-4 border border-[#10b981]/15 hover:border-[#10b981]/30 shadow-[0_8px_30px_rgba(0,0,0,0.5)] flex-1 min-h-[250px] transition-colors flex flex-col overflow-hidden">
                 <div className="flex items-center gap-2 mb-4">
      ...
      <div className={`md:hidden absolute bottom-6 left-4 z-30 transition-transform duration-500 ${!showLeftPanel || isMobileLeftOpen || isFullscreen ? 'translate-y-24' : 'translate-y-0'}`}>
         <button onClick={() => setIsMobileLeftOpen(true)} className="w-12 h-12 bg-black/60 backdrop-blur-md border border-[#10b981]/50 rounded-full flex items-center justify-center text-[#10b981] shadow-[0_0_15px_rgba(59,130,246,0.3)] hover:scale-110 transition-transform">
