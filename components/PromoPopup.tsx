    ...
    return (
        ...
        >
            ...
            <div
                ...
                style={{
                    background: 'linear-gradient(145deg, #020804 0%, #051408 50%, #020804 100%)',
                    border: '2px solid rgba(34,197,94,0.7)',
                    boxShadow: '0 0 80px rgba(34,197,94,0.3), 0 0 200px rgba(34,197,94,0.1)',
            ...
            >
                ...
                <div style={{
                    ...
                    background: 'rgba(34,197,94,0.08)', filter: 'blur(60px)', pointerEvents: 'none',
                }} />
                <div style={{
                    position: 'absolute', left: '-40px', top: '30%',
                    width: '200px', height: '200px', borderRadius: '50%',
                    background: 'rgba(34,197,94,0.05)', filter: 'blur(40px)', pointerEvents: 'none',
                }} />
                ...
                <div className="relative z-10 p-8 md:p-12">
                    ...
                    <div className="flex items-center gap-3 mb-6">
                        <span className="px-3 py-1 text-[10px] font-black uppercase tracking-[0.2em] rounded-full text-white animate-pulse"
                    ...
                    <div className="flex items-center gap-5 mb-6">
                        <div className="w-20 h-20 rounded-2xl flex items-center justify-center flex-shrink-0"
                            ...
                            <span className="text-white font-black text-xs uppercase tracking-tighter leading-tight text-center">BET<br />LİVO</span>
                        </div>
                        <div>
