...
new_hero = """{/* HERO BANNER - ULTRA LUXURY */}
            <div className="w-full relative rounded-2xl overflow-hidden bg-[#030303] min-h-[200px] md:min-h-[280px] lg:min-h-[320px] shadow-[0_20px_60px_rgba(0,0,0,0.8)] border border-white/5 group flex flex-col items-center justify-center p-8 text-center">
                ...
                <div className="relative z-10">
                    <h1 className="text-[24px] sm:text-[32px] lg:text-[44px] font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-500 leading-tight tracking-tight font-['Outfit'] drop-shadow-lg">
                        Premium Casino Deneyimine Hoş Geldiniz
                    </h1>
                    <p className="text-xs md:text-base font-medium max-w-[600px] text-gray-400 drop-shadow-md mt-4">
...
# Only need the clip-tech class now, not the CRT effects
new_styles = """<style>{`
                .clip-tech {
